...
**Sin cifra encontrada, pese a la búsqueda ampliada (Wikipedia, Wikidata, búsquedas específicas de POMCA por corporación)**: Cimitarra, Murrí, Mulatos, San Juan de Urabá, Grande, Guatapé.
- **Guatapé es un caso particular**: según fuentes de EPM, el "Río Guatapé" recibe aguas *desviadas* del Río Nare a través de túneles para aprovechamiento hidroeléctrico — no es un afluente natural en el sentido tradicional, y no aparece como subcuenca propia con código oficial en el POMCA del Río Nare (Tabla 60). Es razonable que no tenga una "longitud de cauce principal" publicada de la misma forma que un río natural.
- Para los otros 5, no se descartan documentos POMCA propios sin localizar todavía — quedan como trabajo pendiente si se necesita completar el dato.
